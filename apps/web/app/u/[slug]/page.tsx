    ...
    >
      ...
      >
        {profile.nowPlaying ? (
          <div
            onClick={() =>
              openSpotifyUrl(profile.nowPlaying.spotifyUrl)
            }
            className="bg-white/10 backdrop-blur-lg rounded-lg p-4 hover:bg-white/20 transition-all cursor-pointer border border-gray-200 dark:border-gray-800"
          >
