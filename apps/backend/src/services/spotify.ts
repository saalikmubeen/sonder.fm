 ...
 */
export const getUser = (headers: SpotifyHeaders) => axios.get('https://api.spotify.com/v1/me', { headers });
 ...
 */
export const getPlaylists = (headers: SpotifyHeaders) => axios.get('https://api.spotify.com/v1/me/playlists', { headers });
 ...
 */
export const getArtist = (artistId: string, headers: SpotifyHeaders) =>
 ...
 */
export const followArtist = (artistId: string, headers: SpotifyHeaders) => {
 ...
 * https://developer.spotify.com/documentation/web-api/reference/follow/follow-artists-users/
 */
export const doesUserFollowArtist = (artistId: string, headers: SpotifyHeaders) =>
 ...
 * https://developer.spotify.com/documentation/web-api/reference/follow/follow-artists-users/
 */
export const doesUserFollowPlaylist = (playlistId: string, userId: string, headers: SpotifyHeaders) =>
 ...
 */
export const createPlaylist = (userId: string, name: string, headers: SpotifyHeaders) => {
 ...
 */
export const addTracksToPlaylist = (playlistId: string, uris: string, headers: SpotifyHeaders) => {
 ...
 */
export const followPlaylist = (playlistId: string, headers: SpotifyHeaders) => {
 ...
 */
export const getPlaylist = (playlistId: string, headers: SpotifyHeaders) =>
 ...
 */
export const getPlaylistTracks = (playlistId: string, headers: SpotifyHeaders) =>
 ...
 */
const getTrackIds = (tracks: any[]) => tracks.map(({ track }) => track.id).join(',');

/**
 * Get Audio Features for Several Tracks
 * https://developer.spotify.com/documentation/web-api/reference/tracks/get-several-audio-features/
 */
export const getAudioFeaturesForTracks = (tracks: any[], headers: SpotifyHeaders) => {
 ...
 */
export const getRecommendationsForTracks = (tracks: any[], headers: SpotifyHeaders) => {
 ...
 */
export const getTrackAudioAnalysis = (trackId: string, headers: SpotifyHeaders) =>
 ...
 */
export const getTrackAudioFeatures = (trackId: string, headers: SpotifyHeaders) =>
  axios.get(`https://api.spotify.com/v1/audio-features/${trackId}`, { headers });

export const getUserInfo = (headers: SpotifyHeaders) =>
  axios
    .all([getUser(headers), getFollowing(headers), getPlaylists(headers), getTopArtistsLong(headers), getTopTracksLong(headers), getTopArtistsMedium(headers), getTopTracksMedium(headers), getTopArtistsShort(headers), getTopTracksShort(headers), getRecentlyPlayed(headers)])
    .then(
      axios.spread((user, followedArtists, playlists, topArtistsLong, topTracksLong, topArtistsMedium, topTracksMedium, topArtistsShort, topTracksShort, recentlyPlayed) => ({
        user: user.data,
...
export const getTrackInfo = (trackId: string, headers: SpotifyHeaders) =>
  axios
